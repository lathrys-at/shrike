...
The normalization itself runs in the native core (shrike-collection's
embed_text.rs); the Python reference implementation lives in
tests/oracles/embed_text_oracle.py under a byte-identity contract (the
