...
| `fetch_media` | Working | Read media back (1-10); per-item `link`(url+path, **default**)/`inline`(base64, opt-in via `max_inline_bytes`)/`missing` union |
