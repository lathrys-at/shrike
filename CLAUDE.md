...
| `store_media` | Working | Store media (1-10) from base64 `data`, `url` (SSRF-guarded), or server-local `path` (purely-local daemon only); per-item results; dedup/collision via Anki |
